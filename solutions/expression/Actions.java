...
public abstract class Actions implements Unification {
    ...
    public int evaluate(int x) {
        return Binary_operation(left_expression.evaluate(x), right_expression.evaluate(x));
    }

    @Override
    public int evaluate(int x, int y, int z) {
        return Binary_operation(left_expression.evaluate(x, y, z), right_expression.evaluate(x, y, z));
    }
